...
[![Windows](https://img.shields.io/badge/Windows_10_11-0078D6?style=for-the-badge&logo=windows&logoColor=white)]()
[![WinRE Ready](https://img.shields.io/badge/WinRE_Ready-9B30FF?style=for-the-badge)]()
...
- **Реестр:** Run, RunOnce, Winlogon, AppInit_DLLs, KnownDLLs, ShellServiceObjectDelayLoad
- **Папки автозагрузки:** пользовательская и общая
- **Планировщик задач:** пользовательские и системные задачи
- **Службы:** с автоматическим запуском
- **Active Setup, Logon Scripts**
